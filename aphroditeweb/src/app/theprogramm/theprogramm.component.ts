...
export class TheprogrammComponent implements OnInit {
  beachesPath = `https://www.google.com/travel/things-to-do/see-all?g2lb=4208993%2C4223281%2C4242` +
  ...
  churchPath = `https://www.google.com/maps/dir/''/%CE%91%CE%B3%CE%AF%CE%B1+%CE%A0%CE%B1%CF%81%CE%B1%CF%83%CE%BA%CE%B5%CF%85%CE%AE` +
